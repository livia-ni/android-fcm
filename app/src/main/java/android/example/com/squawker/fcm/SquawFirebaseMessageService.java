...
public class SquawFirebaseMessageService extends FirebaseMessagingService {
    private static String TAG = SquawFirebaseMessageService.class.getName();
    ...
    public void onMessageReceived(RemoteMessage remoteMessage){
        Log.d(TAG, "data from: " + remoteMessage.getFrom());
